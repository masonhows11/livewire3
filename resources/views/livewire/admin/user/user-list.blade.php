                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="text-left form-control" wire:model="name"
                                        dir="rtl" name="name">
                                    @error('name')
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="text-left form-control" wire:model="email"
                                        dir="rtl" name="email">
                                    @error('email')
                                        <span class="text-danger">
                                            {{ $message }}
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="text-left form-control" wire:model="mobile"
                                        dir="rtl" name="mobile">
                                    @error('mobile')
                                        <span class="text-danger">
                                            {{ $message }}
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="text-left form-control" wire:model="password"
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <input class="col-sm-5" type="file" wire:model="image" class="form-control-file"
                                    id="file">
                                <div class="col-sm-5">
                                    <div wire:loading wire:target="image" class="spinner-border text-danger"
                                        role="status">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                @if ($image)
                                    <img width="150" height="150" src="{{ $image->temporaryUrl() }}"
                                        class="img-thumbnail" alt="image">
                                @else
                                    <img width="150" height="150"
                                        src="{{ asset('default_image/no-image-icon-23494.png') }}" class="img-thumbnail"
                                        alt="image">
                                @endif
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <div class="d-flex justify-content-around">
                        <div class="mr-10">
                            ...
                            <button type="submit" wire:click="$set('search','')"

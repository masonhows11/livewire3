		...
		<div class="row g-4">
			...
			<div class="col-lg-3">
				...
				<a class="me-0" href="index.html">
					{{-- <img class="light-mode-item h-40px" src="front_assets/images/logo.svg" alt="logo">
					<img class="dark-mode-item h-40px" src="front_assets/images/logo-light.svg" alt="logo"> --}}
                    <img class="light-mode-item h-40px" src="{{ asset('default_image/no-image-6663.png') }}" alt="logo">
					<img class="dark-mode-item h-40px" src="{{ asset('default_image/no-image-6663.png') }}" alt="logo">
				</a>
